...
function tar_freeradius_client_install(){
    ...
    wget -c https://github.com/FreeRADIUS/freeradius-client/archive/master.zip
    unzip master.zip
...
#ocserv
#fork，
NET_OC_CONF_DOC="https://raw.githubusercontent.com/barkwind/ocs/master/"
#
Default_oc_version="0.12.3"
#，AllRoute
#All，Route
#
#，ios anyconnect bug，
